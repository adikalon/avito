...
<div class="ui icon message">
	...
	<div class="content">
		...
		<p>Сообщение может содержать спинтаксы - группы фраз-синонимов объединенные в фигурные скобки <b>{текст1|текст2|текст3}</b>. В результате будет выбран один из вариантов разделяемых прямой чертой.</p>
	</div>
</div>
